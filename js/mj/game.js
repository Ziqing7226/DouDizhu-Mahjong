...
(function (global) {
  ...
  function showHelp() {
    UI.showDialog(
      ...
      '<p><b>新手</b>：出牌只看单张价值，副露凭感觉。</p>' +
      '<p><b>高手</b>：记牌推演 —— 按未出现的牌算进张，最小向听 + 最大受入选牌，副露精打细算。</p>' +
      '<p><b>大师</b>：完全信息 AI（能看到所有人手牌，属于作弊难度），与斗地主大师同构 ——' +
      '精确算出每家是否听牌、听哪些张，绝不含糊打出现铳；并按真实牌墙余量计算进张。' +
      '本模式下<b>「提示」按钮整局隐藏</b>，输给它不冤。</p>' +
      '</div>' +
